...
if(isset($_GET['del']))
	{
	mysqli_query($con,"delete from receivers where id = '".$_GET['id']."'");
	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li>
					<a href="receivers.php" class="active"><span class="las la-receipt"></span><span>Receivers</span></a>
				</li>
				<li>
				...
				<div class="projects">
					<div class="card"  style="width:55rem;">
						<div class="card-header">
							...
							<button data-toggle="modal" data-target="#exampleModal">Add Receiver <span class="las la-arrow-right"></span></button>
						</div>
						<div class="card-body">
							...
							<table class="table">
								...
								?>	
									<tr>
										...
										<!-- <td><span class="status purple"></span></td> -->
										<td>
											<a href=""><i class="fas fa-edit" style="font-size:20px;color:#DD2F6E;"></i></a>&nbsp;&nbsp;
											<a href="receivers.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fas fa-trash" style="font-size:20px;color:#DD2F6E;"></i></a>&nbsp;&nbsp;
										</td>
									</tr>
								<?php $cnt=$cnt+1; } ?>
								</tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Insert Receiver</h5>
